...
import SupervisorDebitNoteManagement from "@/components/Dashboard/SupervisorDebitNoteManagement";

const SupervisorDebitNotes = () => {
...
export default SupervisorDebitNotes;
